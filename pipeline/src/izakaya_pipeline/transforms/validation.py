"""Pure validation transform — no IO, fully testable."""
...
def validate_dataframe(
    ...
    Returns:
        (valid_rows, all_errors) where valid_rows are dicts and all_errors are error dicts.
    """
    ...
    for idx, row_data in df.iterrows():
        row_num = int(idx) + 1
        ds_id = int(row_data.get("__data_source_id", data_source_id))
    ...
    return all_valid_rows, all_errors
